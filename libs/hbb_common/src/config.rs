...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk_SYSplus".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.sysplus.co"];
pub const RS_PUB_KEY: &str = "uDLIZwKpOnZRD9qKzw5eMW6fe1Pvnc35Wul43YdXjQw=";
